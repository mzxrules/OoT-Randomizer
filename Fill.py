...
def distribute_items_restrictive(window, worlds, fill_locations=None):
    ...
    shop_locations = [location for world in worlds
    ...
    if not fill_locations:
        fill_locations = [location for world in worlds
                          for location in world.get_unfilled_locations()
    ...
    random.shuffle(world.itempool)  # randomize item placement order. this ordering can greatly affect the location accessibility bias
