...
# TODO: Kept from MM fork, might need to incorporate
# the additions from the OoT fork a few lines down?
TABLE_SIZE_LIMIT = 0x90D8
TEXT_SIZE_LIMIT = 0x6A000

# TODO: This is from the OoT fork.
# Anyone who knows what this is for might know better if this
...
# name of type, followed by number of additional bytes to read,
# follwed by a function that prints the code
CONTROL_CODES = {
...
# TODO: These were removed from the MM fork, but I decided to keep it in.
# It can always be removed again later.
#
...
# TODO: Straight copy from OoT fork.
KEYSANITY_MESSAGES = {
...
class Message():
    ...
    def write(self, rom, index, offset, replace_ending=False, ending=None, always_allow_skip=True, speed_up_text=True, bank=0x07):
        ...
        # TODO: This was from the MM fork, not sure if it's still relevant.
