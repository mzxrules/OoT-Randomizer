...
location_table = {'Hidden Owl Statue': (0x221224E, None, 0x0F, 'Statue'),
    ...
    'Clock Tower Platform HP': (None, None, None, 'Unknown'),
    'Clock Town Business Scrub Item': (None, None, None, 'Unknown'),
    'Clock Town Business Scrub Trade Done': (None, None, None, 'Unknown'),
    'Dropped Ocarina': (None, None, None, 'Unknown'),
    'Deliver Letter to Mama To Postman': (None, None, None, 'Unknown'),
    'ECT 100 Rupee Chest': (None, None, None, 'Unknown'),
    'Honey and Darling Bombchu Bowling Prize': (None, None, None, 'Unknown'),
    'Honey and Darling Archery Prize': (None, None, None, 'Unknown'),
    'Honey and Darling Basket Bomb Throw Prize': (None, None, None, 'Unknown'),
    'Honey and Darling Grand Champion': (None, None, None, 'Unknown'),
    'Treasure Chest Game Goron Prize': (None, None, None, 'Unknown'),
    'Treasure Chest Game Human Prize': (None, None, None, 'Unknown'),
    'Treasure Chest Game Zora Prize': (None, None, None, 'Unknown'),
    'Treasure Chest Game Deku Prize': (None, None, None, 'Unknown'),
    'Town Shooting Gallery Quiver Prize': (None, None, None, 'Unknown'),
    'Town Shooting Gallery HP Prize': (None, None, None, 'Unknown'),
    'Milk Bar Performance': (None, None, None, 'Unknown'),
    'Delivery to Mama Kafei': (None, None, None, 'Unknown'),
    'Stock Pot Inn Key': (None, None, None, 'Unknown'),
    'Have you seen this man?': (None, None, None, 'Unknown'),
    'Grandma Stories HP 1': (None, None, None, 'Unknown'),
    'Grandma Stories HP 2': (None, None, None, 'Unknown'),
    'Toilet Hand HP': (None, None, None, 'Unknown'),
    'Your Room Rupee Chest': (None, None, None, 'Unknown'),
    'Anjus Room Rupee Chest': (None, None, None, 'Unknown'),
    'We Shall Greet The Morning Together': (None, None, None, 'Unknown'),
    'Expert Person Solver Takes the Case': (None, None, None, 'Unknown'),
    'Mayor HP': (None, None, None, 'Unknown'),
    'Bomber Tunnel Chest': (None, None, None, 'Unknown'),
    'Moon Cry': (None, None, None, 'Unknown'),
    'Watch Business Scrub Fly': (None, None, None, 'Unknown'),
    'Moons Tear': (None, None, None, 'Unknown'),
    'Bank 200 Rupee Prize': (None, None, None, 'Unknown'),
    'Bank HP': (None, None, None, 'Unknown'),
    'Rosa Sisters HP': (None, None, None, 'Unknown'),
    'Hidden Owl Statue': (None, None, None, 'Unknown'),
    'Deliver Letter to Kafei': (None, None, None, 'Unknown'),
    'Clock Town Mailbox HP': (None, None, None, 'Unknown'),
    'Buy All Night Mask': (None, None, None, 'Unknown'),
    'Buy Bigger Bomb Bag': (None, None, None, 'Unknown'),
    'Buy Bomb Bag': (None, None, None, 'Unknown'),
    'Counting Is Hard': (None, None, None, 'Unknown'),
    'Sword School HP': (None, None, None, 'Unknown'),
    'Bomber Notebook': (None, None, None, 'Unknown'),
    'Bomber Code': (None, None, None, 'Unknown'),
    'NCT Tree HP': (None, None, None, 'Unknown'),
    'Clock Town Tingle Clock Town Map': (None, None, None, 'Unknown'),
    'Clock Town Tingle Woodfall Map': (None, None, None, 'Unknown'),
    'Foil Sakon': (None, None, None, 'Unknown'),
    'NCT Keaton HP': (None, None, None, 'Unknown'),
    'Clock Town Tingle Pic': (None, None, None, 'Unknown'),
    'Clock Town GF Magic Bar': (None, None, None, 'Unknown'),
    'Clock Town GF Mask': (None, None, None, 'Unknown'),
    'Deku Challenge Day 1': (None, None, None, 'Unknown'),
    'Deku Challenge Day 2': (None, None, None, 'Unknown'),
    'Deku Challenge Day 3': (None, None, None, 'Unknown'),
    'Deku Playground HP': (None, None, None, 'Unknown'),
    'Don Gero Town Frog': (None, None, None, 'Unknown'),
    'Listen To Guru Guru': (None, None, None, 'Unknown'),
    'Keaton Mask From Kafei': (None, None, None, 'Unknown'),
    'Letter From Kafei': (None, None, None, 'Unknown'),
    'Pendant From Kafei': (None, None, None, 'Unknown'),
    'Learn Kamaro Dance': (None, None, None, 'Unknown'),
    'TF Chest In The Grass': (None, None, None, 'Unknown'),
    'TF Chest On A Stump': (None, None, None, 'Unknown'),
    'TF Peahat Grotto HP': (None, None, None, 'Unknown'),
    'TF Beehive Grotto HP': (None, None, None, 'Unknown'),
    'TF East Pillar Bombchu Pit Chest': (None, None, None, 'Unknown'),
    'TF Business Scrub Grotto HP': (None, None, None, 'Unknown'),
    'Swamp Gossip Check': (None, None, None, 'Unknown'),
    '4 Gossip Stone HP': (None, None, None, 'Unknown'),
    'Mountain Gossip Check': (None, None, None, 'Unknown'),
    'Ocean Gossip Check': (None, None, None, 'Unknown'),
    'Canyon Gossip Check': (None, None, None, 'Unknown'),
    'TF Dodongo Grotto HP': (None, None, None, 'Unknown'),
    'TF Deku Baba Pit Chest': (None, None, None, 'Unknown'),
    'Swamp Path Bat Tree HP': (None, None, None, 'Unknown'),
    'Swamp Tingle Woodfall Map': (None, None, None, 'Unknown'),
    'Swamp Tingle Snowhead Map': (None, None, None, 'Unknown'),
    'Swamp Tingle Pic': (None, None, None, 'Unknown'),
    'Swamp Path Rupee Pit Chest': (None, None, None, 'Unknown'),
    'Swamp Shooting Gallery Quiver Prize': (None, None, None, 'Unknown'),
    'Swamp Shooting Gallery HP Prize': (None, None, None, 'Unknown'),
    'Swamp Tourist Roof HP': (None, None, None, 'Unknown'),
    'Kill Swamp Big Octo': (None, None, None, 'Unknown'),
    'Swamp Tourist Free Product (?)': (None, None, None, 'Unknown'),
    'Pictograph Contest Winner': (None, None, None, 'Unknown'),
    'Picto Box': (None, None, None, 'Unknown'),
    'Kill Swamp Big Octo With Boat': (None, None, None, 'Unknown'),
    'Swamp Boat Archery HP': (None, None, None, 'Unknown'),
    'Red Potion To Help Koume': (None, None, None, 'Unknown'),
    'Checked Koume': (None, None, None, 'Unknown'),
    'Saved Koume': (None, None, None, 'Unknown'),
    'Kill Swamp Big Octo From Palace': (None, None, None, 'Unknown'),
    'Octo Grotto 20 Rupee Chest': (None, None, None, 'Unknown'),
    'spiders': (None, None, None, 'Unknown'),
    'so many spiders': (None, None, None, 'Unknown'),
    'Swamp Spider House Reward': (None, None, None, 'Unknown'),
    'Butler Race Prize': (None, None, None, 'Unknown'),
    'Deku Palace Courtyard HP': (None, None, None, 'Unknown'),
    'Magic Beans': (None, None, None, 'Unknown'),
    'Return Deku Princess': (None, None, None, 'Unknown'),
    'Song From Kaepora Gaebora': (None, None, None, 'Unknown'),
    'Outside Woodfall 20 Rupee Chest': (None, None, None, 'Unknown'),
    'Outside Woodfall 5 Rupee Chest': (None, None, None, 'Unknown'),
    'Woodfall Owl Statue (Poisoned)': (None, None, None, 'Unknown'),
    'Outside Woodfall HP': (None, None, None, 'Unknown'),
    'Woodfall GF Reward': (None, None, None, 'Unknown'),
    'WF Stray Fairy Entrance': (None, None, None, 'Unknown'),
    'WF Stray Fairy Lobby Chest': (None, None, None, 'Unknown'),
    'WF Stray Fairy Poisoned Central Room Deku Baba': (None, None, None, 'Unknown'),
    'WF Clean Poison Water Using Fire Arrows': (None, None, None, 'Unknown'),
    'WF Poisoned Central Room Gate Torch Using Fire Arrows': (None, None, None, 'Unknown'),
    'WF Stray Fairy Poisoned Central Room SE Corner': (None, None, None, 'Unknown'),
    'WF Stray Fairy Poisoned Central Room Upper Switch Chest': (None, None, None, 'Unknown'),
    'WF Poisoned Central Room Ladder Switch': (None, None, None, 'Unknown'),
    'WF Clean Poison Water': (None, None, None, 'Unknown'),
    'WF Stray Fairy Central Room Upper Bubble': (None, None, None, 'Unknown'),
    'WF Activate Elevator From Poisoned West Lower': (None, None, None, 'Unknown'),
    'WF Activate Elevator From Poisoned East Lower': (None, None, None, 'Unknown'),
    'WF Poisoned Elevator Room Key Chest': (None, None, None, 'Unknown'),
    'WF Stray Fairy Elevator Room': (None, None, None, 'Unknown'),
    'WF Map Chest': (None, None, None, 'Unknown'),
    'WF Stray Fairy Poisoned Push Block Room Hive': (None, None, None, 'Unknown'),
    'WF Stray Fairy Poisoned Push Block Room Skulltula': (None, None, None, 'Unknown'),
    'WF Stray Fairy Push Block Room Underwater': (None, None, None, 'Unknown'),
    'WF Compass Chest': (None, None, None, 'Unknown'),
    'WF Stray Fairy Dark Puffs': (None, None, None, 'Unknown'),
    'WF Bow Chest': (None, None, None, 'Unknown'),
    'WF Boss Key Chest': (None, None, None, 'Unknown'),
    'WF Don Gero Frog': (None, None, None, 'Unknown'),
    'WF Stray Fairy Pre Boss Room Alcoves 1': (None, None, None, 'Unknown'),
    'WF Stray Fairy Pre Boss Room Alcoves 2': (None, None, None, 'Unknown'),
    'WF Stray Fairy Pre Boss Room Alcoves 3': (None, None, None, 'Unknown'),
    'WF Stray Fairy Pre Boss Room Bubble': (None, None, None, 'Unknown'),
    'Odolwa HC': (None, None, None, 'Unknown'),
    'Song From Giants': (None, None, None, 'Unknown'),
    'Odolwas Remains': (None, None, None, 'Unknown'),
    'Deku Princess': (None, None, None, 'Unknown'),
    ...
    'Great Bay GF Reward': (None, None, None, 'Unknown'),
    'Captains Chest': (None, None, None, 'Unknown'),
    'Stone Tower GF Reward': (None, None, None, 'Unknown'),
    ###
