...
location_table = {
    ...
    'Goron Mask': (None, None, None, 'Unknown'),
    'Goron Grave Hot Spring Water': (None, None, None, 'Unknown'),
    'Don Gero Mask': (None, None, None, 'Unknown'),
    'Mountain Village 20 Rupee Chest Behind Waterfall': (None, None, None, 'Unknown'),
    'Mountain Village 20 Rupee Pit': (None, None, None, 'Unknown'),
    'Gilded Sword': (None, None, None, 'Unknown'),
    'Mountain Village Keaton HP': (None, None, None, 'Unknown'),
    'Don Gero HP': (None, None, None, 'Unknown'),
    'Mountain Tingle Snowhead Map': (None, None, None, 'Unknown'),
    'Mountain Tingle Romani Ranch Map': (None, None, None, 'Unknown'),
    'Mountain Tingle Pic': (None, None, None, 'Unknown'),
    'First Half Goron Lullaby': (None, None, None, 'Unknown'),
    'Frozen Lake HP': (None, None, None, 'Unknown'),
    'Frozen Lake Bombchu Pit': (None, None, None, 'Unknown'),
    'Goron Race Gold Dust Bottle': (None, None, None, 'Unknown'),
    'Biggest Bomb Bag': (None, None, None, 'Unknown'),
    'Lens of Truth Cave Invisible Chest': (None, None, None, 'Unknown'),
    'Lens of Truth Cave Boulder Chest': (None, None, None, 'Unknown'),
    'Learn Goron Lullaby': (None, None, None, 'Unknown'),
    'Rock Sirloin': (None, None, None, 'Unknown'),
    'Path To Snowhead HP': (None, None, None, 'Unknown'),
    'Snowhead Owl Statue': (None, None, None, 'Unknown'),
    'SH Stray Fairy 1 Bridge And Freezard Room': (None, None, None, 'Unknown'),
    'SH Stray Fairy 2 Bridge And Freezard Room': (None, None, None, 'Unknown'),
    'SH Stray Fairy Basement Switch': (None, None, None, 'Unknown'),
    'SH Bridge and Freezard Room Key Chest': (None, None, None, 'Unknown'),
    'SH Stray Fairy Chest In Compass Room': (None, None, None, 'Unknown'),
    'SH Stray Fairy Compass Room Bombable': (None, None, None, 'Unknown'),
    'SH Stray Fairy Push Block Room': (None, None, None, 'Unknown'),
    'SH Stray Fairy Behind Central Pillar Room': (None, None, None, 'Unknown'),
    'SH Icicle Drop Room Key Chest': (None, None, None, 'Unknown'),
    'SH Stray Fairy Icicle Drop Room': (None, None, None, 'Unknown'),
    'SH Stray Fairy Goron Switch Room Ceiling': (None, None, None, 'Unknown'),
    'SH Fire Arrows Chest': (None, None, None, 'Unknown'),
    'SH Stray Fairy Elevator Room Lens Platforms': (None, None, None, 'Unknown'),
    'SH Stray Fairy 3F Snowman Room': (None, None, None, 'Unknown'),
    'SH Stray Fairy 1 Lizalfos Room': (None, None, None, 'Unknown'),
    'SH Stray Fairy 2 Lizalfos Room': (None, None, None, 'Unknown'),
    'SH Stray Fairy Hidden Alcove': (None, None, None, 'Unknown'),
    'SH Boss Key Chest': (None, None, None, 'Unknown'),
    'Ghots Remains': (None, None, None, 'Unknown'),
    'Milk Road Keaton HP': (None, None, None, 'Unknown'),
    'Milk Road Tingle Romani Ranch Map': (None, None, None, 'Unknown'),
    'Milk Road Tingle Other Map': (None, None, None, 'Unknown'),
    'Milk Road Tingle Pic': (None, None, None, 'Unknown'),
    'Bunny Hood': (None, None, None, 'Unknown'),
    'Learn Eponas Song': (None, None, None, 'Unknown'),
    'Romani Ranch Bottle': (None, None, None, 'Unknown'),
    'Dog Track HP': (None, None, None, 'Unknown'),
    'Romani Mask': (None, None, None, 'Unknown'),
    'Garo Mask': (None, None, None, 'Unknown'),
    'Zora Mask': (None, None, None, 'Unknown'),
    'Great Bay Owl Statue': (None, None, None, 'Unknown'),
    'Great Bay Tingle Great Bay Map': (None, None, None, 'Unknown'),
    'Great Bay Tingle Ikana Map': (None, None, None, 'Unknown'),
    'Great Bay Tingle Pic': (None, None, None, 'Unknown'),
    'Ocean Spider House HP': (None, None, None, 'Unknown'),
    'Ocean Spider House Giant Wallet': (None, None, None, 'Unknown'),
    'Great Bay Lab Fish Feeding HP': (None, None, None, 'Unknown'),
    'Great Bay Seahorse From Fisherman': (None, None, None, 'Unknown'),
    'Learn New Wave Bossa Nova': (None, None, None, 'Unknown'),
    'Great Bay High Cliff HP': (None, None, None, 'Unknown'),
    'Great Bay Jumping Game HP': (None, None, None, 'Unknown'),
    'Great Bay Like Like HP': (None, None, None, 'Unknown'),
    'Great Bay Temple Owl Statue': (None, None, None, 'Unknown'),
    'Zora Hall 5 Rupees From Stagehand': (None, None, None, 'Unknown'),
    'Zora Hall 20 Rupees From Lulu Stalker': (None, None, None, 'Unknown'),
    'Beaver Race Bottle': (None, None, None, 'Unknown'),
    'Beaver Race HP': (None, None, None, 'Unknown'),
    'Zora Hall Song HP': (None, None, None, 'Unknown'),
    'Gerudo Fortress Entrance Harbor 20 Rupee Chest 1': (None, None, None, 'Unknown'),
    'Gerudo Fortress Entrance Harbor 20 Rupee Chest 2': (None, None, None, 'Unknown'),
    'Gerudo Fortress Entrance Harbor 20 Rupee Chest 3': (None, None, None, 'Unknown'),
    'Gerudo Fortress Cage Maze 20 Rupee Chest': (None, None, None, 'Unknown'),
    'Gerudo Fortress Cage Maze HP': (None, None, None, 'Unknown'),
    'Gerudo Fortress Tower Hub 20 Rupee Chest': (None, None, None, 'Unknown'),
    'Hookshot': (None, None, None, 'Unknown'),
    'Zora Egg 1': (None, None, None, 'Unknown'),
    'Zora Egg 2': (None, None, None, 'Unknown'),
    'Zora Egg 3': (None, None, None, 'Unknown'),
    'Zora Egg 4': (None, None, None, 'Unknown'),
    'Gerudo Fortress 100 Rupee Chest': (None, None, None, 'Unknown'),
    'Zora Egg 5': (None, None, None, 'Unknown'),
    'Zora Egg 6': (None, None, None, 'Unknown'),
    'Zora Egg 7': (None, None, None, 'Unknown'),
    'Pinnacle Rock Eel HP': (None, None, None, 'Unknown'),
    'GB Stray Fairy Entrance Room': (None, None, None, 'Unknown'),
    'GB Stray Fairy Flywheel Room Underwater': (None, None, None, 'Unknown'),
    'GB Stray Fairy Flywheel Room Big Skulltula': (None, None, None, 'Unknown'),
    'GB Stray Fairy Big Whirlpool Hub Barrel': (None, None, None, 'Unknown'),
    'GB Stray Fairy Big Whirlpool Hub Bottom': (None, None, None, 'Unknown'),
    'GB Map Chest': (None, None, None, 'Unknown'),
    'GB Stray Fairy Map Room': (None, None, None, 'Unknown'),
    'GB Stray Fairy Tunnel To Compass Room': (None, None, None, 'Unknown'),
    'GB Compass Chest': (None, None, None, 'Unknown'),
    'GB Compass Room Key Chest': (None, None, None, 'Unknown'),
    'GB Stray Fairy Compass Room': (None, None, None, 'Unknown'),
    'GB Ice Arrows Chest': (None, None, None, 'Unknown'),
    'GB Boss Key Chest': (None, None, None, 'Unknown'),
    'GB Stray Fairy First Green Crank Room': (None, None, None, 'Unknown'),
    'GB Stray Fairy Waterfall Room 1': (None, None, None, 'Unknown'),
    'GB Stray Fairy Waterfall Room 2': (None, None, None, 'Unknown'),
    'GB Stray Fairy Final Crank Room 1': (None, None, None, 'Unknown'),
    'GB Stray Fairy Final Crank Room 2': (None, None, None, 'Unknown'),
    'GB Stray Fairy Before Gyorg Room 1': (None, None, None, 'Unknown'),
    'GB Stray Fairy Before Gyorg Room 2': (None, None, None, 'Unknown'),
    'Gyorgs Remains': (None, None, None, 'Unknown'),
    'Ikana Entrance Bombchu Pit': (None, None, None, 'Unknown'),
    'Stone Mask': (None, None, None, 'Unknown'),
    'Ikana Graveyard Bombchu Pit': (None, None, None, 'Unknown'),
    'Ikana Graveyard Dampe 30 Rupee Prize': (None, None, None, 'Unknown'),
    'Captains Hat': (None, None, None, 'Unknown'),
    'Ikana Graveyard First Night Grave 50 Rupee Chest': (None, None, None, 'Unknown'),
    'Learn Song of Storms': (None, None, None, 'Unknown'),
    'Ikana Graveyard Second Night Grave HP': (None, None, None, 'Unknown'),
    'Ikana Graveyard Third Night Grave Bottle': (None, None, None, 'Unknown'),
    'Ikana Canyon Owl Statue': (None, None, None, 'Unknown'),
    'Ikana Tingle Ikana Map': (None, None, None, 'Unknown'),
    'Ikana Tingle Clock Town Map': (None, None, None, 'Unknown'),
    'Ikana Tingle Pic': (None, None, None, 'Unknown'),
    'Ikana Secret Shrine HP': (None, None, None, 'Unknown'),
    'Gibdo Mask': (None, None, None, 'Unknown'),
    'Ghost Hut HP': (None, None, None, 'Unknown'),
    'Beneath the Well 50 Rupee Chest 1': (None, None, None, 'Unknown'),
    'Beneath the Well 50 Rupee Chest 2': (None, None, None, 'Unknown'),
    'Mirror Shield': (None, None, None, 'Unknown'),
    'Ikana Castle Pillar HP': (None, None, None, 'Unknown'),
    'Learn Elegy of Emptiness': (None, None, None, 'Unknown'),
    'Stone Tower Owl Statue': (None, None, None, 'Unknown'),
    'ST Stray Fairy Entryway 1': (None, None, None, 'Unknown'),
    'ST Map Chest': (None, None, None, 'Unknown'),
    'ST Map Room Key Chest': (None, None, None, 'Unknown'),
    'ST Stray Fairy Map Room': (None, None, None, 'Unknown'),
    'ST Pool Room Key Chest': (None, None, None, 'Unknown'),
    'ST Compass Chest': (None, None, None, 'Unknown'),
    'ST Stray Fairy Mirror Network Room 1': (None, None, None, 'Unknown'),
    'ST Stray Fairy Mirror Network Room 2': (None, None, None, 'Unknown'),
    'ST Stray Fairy Lava Room Center Chest': (None, None, None, 'Unknown'),
    'ST Stray Fairy Lava Room Switch Chest': (None, None, None, 'Unknown'),
    'ST Light Arrows Chest': (None, None, None, 'Unknown'),
    'ST Stray Fairy Pool Room Eyegore': (None, None, None, 'Unknown'),
    'ST Stray Fairy Pool Room Behind Sun Block': (None, None, None, 'Unknown'),
    'ST Stray Fairy Inverted Entryway': (None, None, None, 'Unknown'),
    'ST Inverted Compass Room Key Chest': (None, None, None, 'Unknown'),
    'ST Stray Fairy Inverted Compass Room 1': (None, None, None, 'Unknown'),
    'ST Stray Fairy Inverted Compass Room 2': (None, None, None, 'Unknown'),
    'ST Stray Fairy Compass Room': (None, None, None, 'Unknown'),
    'ST Stray Fairy Wizrobe Room': (None, None, None, 'Unknown'),
    'ST Inverted Map Room Key': (None, None, None, 'Unknown'),
    'ST Boss Key Chest': (None, None, None, 'Unknown'),
    'ST Stray Fairy Entryway 2': (None, None, None, 'Unknown'),
    'ST Stray Fairy Post Garo Master Room': (None, None, None, 'Unknown'),
    'Twinmodls Remains': (None, None, None, 'Unknown'),
    'Moon Odolwa Child HP': (None, None, None, 'Unknown'),
    'Moon Ghot Child HP': (None, None, None, 'Unknown'),
    'Moon Gyorg Child HP': (None, None, None, 'Unknown'),
    'Moon Twinmold Child Bombchu Chest': (None, None, None, 'Unknown'),
    'Moon Twinmold Child HP': (None, None, None, 'Unknown'),
    'Fierce Deity Mask': (None, None, None, 'Unknown'),
    ###
